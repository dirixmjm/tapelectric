"""
Custom integration to integrate tapelectric with Home Assistant.

For more details about this integration, please refer to
https://github.com/dirixmjm/tapelectric
"""
...
from .data import IntegrationTAPElectricData
...
async def async_setup_entry(
    ...
    entry.runtime_data = IntegrationTAPElectricData(
