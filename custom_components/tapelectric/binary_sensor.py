"""Binary sensor platform for tapelectric."""
...
ENTITY_DESCRIPTIONS = (
    BinarySensorEntityDescription(
        key="tapelectric",
        name="TAP Electric Binary Sensor",
...
async def async_setup_entry(
    ...
    async_add_entities(
        IntegrationTAPElectricBinarySensor(
...
class IntegrationTAPElectricBinarySensor(
    IntegrationTAPElectricEntity, BinarySensorEntity
):
    """tapelectric binary_sensor class."""
