"""Switch platform for tapelectric."""
...
class IntegrationTAPElectricSwitch(IntegrationTAPElectricEntity, SwitchEntity):
    """tapelectric switch class."""
